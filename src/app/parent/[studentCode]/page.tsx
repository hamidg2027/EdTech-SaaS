...
import { School, CheckCircle2, XCircle, TrendingUp, Award, Calendar, DollarSign, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 pb-12">
      ...
      <header className="bg-slate-900 text-white px-6 py-6 border-b border-slate-800">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <Link
            href="/parent"
            className="inline-flex items-center gap-1 text-xs text-slate-300 hover:text-white bg-slate-800 px-3 py-1.5 rounded-lg border border-slate-700"
          >
        ...
        <div className="bg-white rounded-3xl p-6 md:p-8 border border-slate-200/80 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <div className="inline-flex items-center gap-1.5 text-xs font-bold text-emerald-700 bg-emerald-50 px-3 py-1 rounded-full mb-2">
              ...
              <span>طالب نشط ومسجل</span>
            </div>
            <h2 className="text-2xl font-black text-slate-800">أحمد براهيمي</h2>
            <p className="text-xs text-slate-500 mt-1">
              الفوج: <strong>فوج البكالوريا - علوم طبيعية</strong> • الكود: <span className="font-mono">{code}</span>
            </p>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div className="bg-slate-50 border border-slate-200/80 p-4 rounded-2xl text-center min-w-[110px]">
              ...
              <div className="text-2xl font-black text-blue-600 mt-1">17.5 / 20</div>
              <span className="text-[10px] text-emerald-600 font-semibold">+14% تطور</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl p-6 md:p-8 border border-slate-200/80 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-slate-800 text-base">سجل حضور الحصص الأخيرة</h3>
            </div>
            <span className="text-xs text-slate-400">آخر 5 حصص</span>
          </div>

          <div className="space-y-2">
            {[
              { date: '15 أوت 2026', topic: 'الانقسام الخيطي المتساوي وتطبيقاته', status: 'حاضر', ok: true },
              { date: '12 أوت 2026', topic: 'آلية تركيب البروتين - الترجمة', status: 'حاضر', ok: true },
        ...
        <div className="bg-white rounded-3xl p-6 md:p-8 border border-slate-200/80 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-slate-800 text-base">نتائج الاختبارات ومؤشر التطور</h3>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100 space-y-1">
              ...
              <p className="text-[11px] text-slate-400">ملاحظة الأستاذ: استيعاب جيد مع الحاجة للتركيز على المنهجية</p>
            </div>
        ...
        <div className="bg-white rounded-3xl p-6 md:p-8 border border-slate-200/80 shadow-sm flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <span className="text-xs text-emerald-600 font-semibold">خالص بالكامل (3000 دج) — شكراً لكم</span>
            </div>
          </div>
